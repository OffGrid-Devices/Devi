...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 165.0, 184.0, 18.0 ],
									"presentation_rect" : [ 97.0, 171.0, 0.0, 0.0 ],
									"text" : "60 0, 63 0, 66 0, 69 0, 72 0, 75 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 135.0, 264.0, 18.0 ],
									"text" : "60 100, 63 100, 66 100, 69 100, 72 100, 75 100"
								}
...
,
					"patching_rect" : [ 847.5, 600.0, 89.0, 20.0 ],
					"presentation_rect" : [ 847.5, 599.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 169.0, 735.0, 42.0, 20.0 ],
					"text" : "midiin"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 154.5, 244.0, 18.0 ],
									"text" : "60 0, 63 0, 66 0, 69 0, 72 0, 75 0, 78 0, 81 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 130.0, 351.0, 18.0 ],
									"text" : "60 100, 63 100, 66 100, 69 100, 72 100, 75 100, 78 100, 81 100"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 53.0, 232.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 960.0, 570.0, 89.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 825.0, 524.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.0, 450.0, 336.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 495.0, 354.0, 125.0, 60.0 ],
					"varname" : "oi.idv.key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 645.0, 585.0, 34.0, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 645.0, 561.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 645.0, 531.0, 43.0, 20.0 ],
					"text" : "sel 13"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.5, 645.0, 81.0, 20.0 ],
					"text" : "MIDI channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 620.0, 65.0, 20.0 ],
					"text" : "r midiout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 175.5, 645.0, 36.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 530.0, 609.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 635.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 718.0, 59.0, 20.0 ],
					"text" : "s midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 480.0, 688.0, 100.0, 20.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 870.0, 675.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 750.0, 540.0, 43.0, 20.0 ],
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 750.0, 510.0, 59.5, 20.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 675.5, 36.0, 20.0 ],
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 735.0, 59.0, 20.0 ],
					"text" : "s midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 750.0, 705.0, 100.0, 20.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 86.5, 510.5, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.5, 304.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.5, 264.0, 50.0, 31.0 ],
					"text" : "19.555555"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.5, 231.0, 150.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 46.0, 570.0, 100.0, 20.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 137.0, 517.0, 168.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 765.0, 49.0, 20.0 ],
					"text" : "midiout"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "oi.idv.key.maxpat",
				"bootpath" : "/Users/tiagoangelo/Documents/Max/Packages/OpenInstruments-master/patchers/oi.modules/oi.modules.devices/Input",
				"patcherrelativepath" : "../Documents/Max/Packages/OpenInstruments-master/patchers/oi.modules/oi.modules.devices/Input",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "oi.autovarname.js",
				"bootpath" : "/Users/tiagoangelo/Documents/Max/Packages/OpenInstruments-master/javascript",
				"patcherrelativepath" : "../Documents/Max/Packages/OpenInstruments-master/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "oi.modulecom.maxpat",
				"bootpath" : "/Users/tiagoangelo/Documents/Max/Packages/OpenInstruments-master/patchers/oi.utils/Communication/Parameter_data",
				"patcherrelativepath" : "../Documents/Max/Packages/OpenInstruments-master/patchers/oi.utils/Communication/Parameter_data",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "oi.modulegate.maxpat",
				"bootpath" : "/Users/tiagoangelo/Documents/Max/Packages/OpenInstruments-master/patchers/oi.utils/System/Data_flow",
				"patcherrelativepath" : "../Documents/Max/Packages/OpenInstruments-master/patchers/oi.utils/System/Data_flow",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
